                ...
                <div class="card">
                    <div class="content">
                        <form>
                            <div class="row">
                                <div class="row">
                                    <p class="h2 text-center">Líneas</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
...
<script>
    $(document).ready(function () {
        ...
        if (JSON.stringify(Lines) !== '[]') {
            ...
            var contador = 0;
            var flag = false;
            var optionCompanies = "<div class='col-md-3'><div class='form-group'><select class='selectpicker selectLineCompanies' title='Seleccione una compañía' multiple data-live-search='true' data-actions-box='true' data-selected-text-format='count'>";
            var count = 0;
