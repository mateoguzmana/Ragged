...
<script>
    $(document).ready(function () {
        ...
        if (JSON.stringify(Colors) !== '[]') {
            ...
            var contador = 0;
            var flag = false;
            var optionCompanies = "<div class='col-md-3'><div class='form-group'><select class='selectpicker selectColorCompanies' title='Seleccione una compañía' multiple data-live-search='true' data-actions-box='true' data-selected-text-format='count'>";
            var count = 0;
